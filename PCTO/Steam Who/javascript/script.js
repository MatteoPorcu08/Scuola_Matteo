window.onload = function() {
    ...
    const questions = [
        ...
        { testo: "Gli/le è stato dedicato un elemento chimico nella tavola periodica?", key: "elemento_chimico" },
        { testo: "È stato costretto a fuggire dal proprio paese a causa di persecuzioni o leggi razziali?", key: "fuga_esilio" },
    ...
    function showGuess(bestGuess = null) {
        ...
        document.getElementById("correctBtn").onclick = () => {
            ...
            result.innerHTML = `<h2 style="color:#22c55e;">HO VINTO!<br> Sapevo che era ${best.nome}!</h2>`;
