function AggiungiEsameSvolgere() {
    ...
    if (nome != null && nome != "") {
        ...
        document.getElementById("tabellaSvolgere").innerHTML +=
            "<tr><td>" + nome + "</td></tr>";

        document.getElementById("numeroesamisvolgere").innerHTML =
            document.getElementById("numeroesamisvolgere").innerHTML * 1 + 1;

        document.getElementById("esameaggiuntosvolgere").innerHTML =
...
function Paga() {
    ...
    document.getElementById("sommapagare").innerHTML =
        totale - paga;
}